...
function Corporate(){
    return(
                ...
                <div class="section-internal">
                    ...
                    <div class="row align-items-center">
                        <div class="col-12">
                            ...
                            <p class="mb-4">Join Kardinal and help power growth for a new generation of businesses across Africa.</p>
                            <a href="auth_register.html" class="btn1" >
                                See Our Production
                            </a>
                        </div>
                        </div>
        ...
        // {/* <!-- /.breadcrumb-area --> */}
        // {/* <!--====== End Breadcrumb Area ======--> */}
        <section class="collaboration-area collaboration-area-v2 pt-100 pb-50 border-top">
            <div class="container">
                <div class="row align-items-center">
                    
                    <div class="col-lg-12">
                        <div class="section-title text-center" style="padding: 0 10%;">
                           
                            <div class="section-title-description">
                                <p class="mb-5">Kardinal, one of the leading companies in the country in the fields of attractions and event production,provides a wide and comprehensive range of services under one roof to companies, organizations and institutions. The company's staff includes top professionals in the country, all with rich experience of over 20 years in the field of events. Among other things, the company offers a business event production service at the highest level and in perfect accordance with the requirements and needs of the customer</p>
                                <p class="mb-4">"I produced a business event through Kardinal. Everything went quickly and conveniently."</p>
                                <p class="mb-5" style="text-align: center;">Jordan</p>
                                <p class="mb-4">Kardinal definitely proved themselves. The level of service we received was excellent, everything went according to time.The employees were satisfied, we received endless compliments</p>
                                <p class="mb-2" style="text-align: center;">Tali</p>
                            </div>
                            <h2>Want to get all the details? Talk to us now</h2>
                            <h2 style="text-align: center;">Phone: 077-2315716</h2>
                        </div>
                    </div>
                </div> 
                {/* <!-- /.row --> */}
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4">
                        <div class="single-info-box wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0.1s; animation-name: fadeInUp;">
                            <div class="infobox-thumbnail">
                                <a href="#">
                                    <img src="assets/img/services/pic1.jpg" alt="service thumbnail one" />
                                </a>
                            </div>
                            <div class="infobox-body ebook-box">
                    ...
                    <div class="col-sm-12 col-md-4">
                        <div class="single-info-box wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0.4s; animation-name: fadeInUp;">
                            <div class="infobox-thumbnail">
                                <a href="#">
                                    <img src="assets/img/services/pic1.jpg" alt="service thumbnail two" />
                                </a>
                            </div>
                            <div class="infobox-body ebook-box">
                                <h5 class="infobox-title">
                    ...
                    <div class="col-sm-12 col-md-4">
                        <div class="single-info-box wow fadeInUp" data-wow-delay="0.6s" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0.6s; animation-name: fadeInUp;">
                            <div class="infobox-thumbnail">
                                <a href="#">
                                    <img src="assets/img/services/pic1.jpg" alt="service thumbnail three" />
                                </a>
                            </div>
                            <div class="infobox-body ebook-box">
                                <h5 class="infobox-title">
                    ...
                    <div class="col-sm-12 col-md-4">
                        <div class="single-info-box wow fadeInUp" data-wow-delay="0.8s" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0.8s; animation-name: fadeInUp;">
                            <div class="infobox-thumbnail">
                                <a href="#">
                                    <img src="assets/img/services/pic1.jpg" alt="service thumbnail four" />
                                </a>
                            </div>
                            <div class="infobox-body ebook-box">
                                <h5 class="infobox-title">
     ...
     <section class="our-services our-services-v1 pt-100 pb-100" style="background-image: url(assets/img/services/dots-pattern-bg.png);">
            <div class="container">
                <div class="service-area-internal">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12">
                            <div class="section-title mb-25 text-center section-title-ocean-blue">
                                <div class="section-heading-tag">
                                    <span class="single-heading-tag">Work We Do</span>
                                </div>
                                <h2>Our sample about <br class="d-none d-md-block" />
                                    <span>Production </span> 
                                    we do
                                </h2>
                                <p class="mb-3" >As a leading company in the field of attractions, effects and event production, we offer leading companies and organizations in the Israeli economy a professional event production service, among other things, we provide a solution for the following events:</p>
                                <p class="mb-3 justify-content-flex-start">Fun and formation days all over the country<br />Conference production<br />Exhibition production<br />Production of parties<br />Production of exhibitions and pavilions<br />Production of fun days and formation</p>
                                <p class="mb-3">It is important to note that Avnet Plus specializes in private and business event production services, the company offers a variety of attractions, gimmicks, sessions for all ages and for any event including fun and formation days, bar mitzvahs, bat mitzvahs and special and exciting events for children. We also produce birthdays for all ages, and plan a sparkling and memorable party with a variety of attractions and activities</p>
                                <p>Producing an event for a company begins with formulating an idea, choosing a location, planning activities and original and varied activities in accordance with the purpose of the event, and formulating a concept for the design of the place. The company staff works jointly with the customer's representatives and accompanies them throughout the production stages, from the planning stage, through the actual execution and management of the event until its successful completion</p>
                            </div>
                        </div>
                    </div> 
                    {/* <!-- /.row --> */}
        ...
        <section class="cta-area cta-area-v2" style="background-image: url(assets/img/cta/ctabg.jpg);">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="cta-content">
                            <div class="section-title section-title-white text-center">
                                <h2 class="wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0.2s; animation-name: fadeInUp;">Production of <br class="d-none d-md-block" /> Kardinal</h2>
                                <div class="section-heading-tag wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0.1s; animation-name: fadeInUp;">
                                    <span class="single-heading-tag">Event production is not a trivial matter, there are many event producers in the country so it is worth knowing that Event Plus is one of the leading companies in the 
                ...
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <div class="section-title text-center" style="padding: 0 10%;">
                            ...
                            <div class="section-title-description">
                                <p class="mb-5">For us, organizing events for companies and organizations, requires us to professionally and 
                            ...
                            <div class="subscribe-newsletter-content">
                                <div class="section-title mb-35">
                                    <div class="section-heading-tag wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1500ms">
                                        <span class="single-heading-tag">Try Kardinal Now</span>
                                    </div>
                                    <h2 class="wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="1500ms">For more details please contact us by phone</h2>
                                    <h3 class="wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="1500ms">Leave details on the website and receive an attractive and customized offer</h3>
                                </div>
                                <div class="newsletter-form newsletter-form-v2 wow fadeInUp" data-wow-delay="0.5s" data-wow-duration="1500ms">
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <button type="submit" name="submit" value="Go" class="filled-btn">Send</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
