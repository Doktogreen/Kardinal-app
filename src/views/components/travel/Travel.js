...
import customer_care from "../../../assets/general-assets/img/travel/customer_care.svg";
import travel_img6 from "../../../assets/general-assets/img/travel/img_6.png";
import policy from "../../../assets/general-assets/img/travel/policy.svg";
import travel_card from "../../../assets/general-assets/img/travel/card.svg";
import travel_img5 from "../../../assets/general-assets/img/travel/img_5.png";
import travel_img4 from "../../../assets/general-assets/img/travel/img_4.png";
import travel_img1 from "../../../assets/general-assets/img/travel/img_1.png";
import kardinal_travel from "../../../assets/general-assets/img/travel/kardinal-travel.svg";
import travel_img2 from "../../../assets/general-assets/img/travel/img_2.png";
import travel_overview from "../../../assets/general-assets/img/travel/travel_overview.svg";
import travel_img3 from "../../../assets/general-assets/img/travel/img_3.png";
import travel_reporting from "../../../assets/general-assets/img/travel/reporting.svg";
...
function Travel(){
    return(
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="hero-content">
                            <div class="section-particle-effect d-none d-lg-block">
                                <img class="particle-1 animate-rotate-me" src={particle_two} alt="particle One" />
                                <img class="particle-2 animate-float-bob-y" src={particle_one} alt="particle Two" />
                                <img class="particle-3 animate-zoominout" src={particle_four} alt="particle Three" />
                                <img class="particle-4 animate-float-bob-y" src={particle_five} alt="particle Four" />
                            </div>
                            <div class="section-title section-title-mandy">
                                <h1 class="wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="1500ms" style={{visibility: "visible", animationDuration: "1500ms", animationDelay: "0.2s", animationName: "fadeInUp"}}>Simplified <span>business</span> travelling</h1>
                                <p class="mb-4">One platform for simplified business travelling. Seamlessly manage your business trips; from booking to payment, invoicing and Reporting. You can view your trips on the go. </p>
                    ...
                    <div class="col-lg-6">
                        <div class="chartboard-image-wrapper">
                            <img src={travel_img1} alt=" im one" class="chartboard-image chartboard-image-main wow fadeInDown animate-float-bob-x animated" data-wow-delay="100ms" data-wow-duration="1500ms" style={{visibility: "visible", animationDuration: "1500ms", animationDelay: "100ms", animationName: "float-bob-x"}} />
                            <div class="chartboard-app-preview">
                                <img src={kardinal_travel} alt="kardinal_services" class="chartboard-image chartboard-app-preview-3 wow fadeInDown" data-wow-delay="300ms" data-wow-duration="1500ms" style={{right: "20px", bottom: "40px", visibility: "visible", animationDuration: "1500ms", animationDelay: "300ms", animationName: "fadeInDown"}} />
                            </div>
                        </div> 
                    ...
                    <div class="col-lg-7">
                        <div class="app-preview-image oval-gradient content-right-spacer">
                            <div class="app-feature-preview-main wow fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms" style={{visibility: "visible", animationDuration: "1500ms", animationDelay: "200ms", animationName: "fadeInDown"}}>
                                <img src={travel_img2} alt=" collaboration" />
                            </div>
                            <div class="app-feature-preview-absolute animate-float-bob-x wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms" style={{visibility: "visible", animationDuration: "1500ms", animationDelay: "600ms", animationName: "float-bob-x"}}>
                                <img src={travel_overview} alt=" onboard" />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <div class="section-title section-title-mirage">
                            ...
                            <div class="section-title-description">
                                <p class="mb-13">We offer the widest range of flight inventory to ensure the best rate for every booking you make. Our dashboard makes it easy for you to keep tabs on all your activities and expenses, right in one place.</p>
                    ...
                    <div class="col-lg-7 order-1 order-lg-2">
                        <div class="app-preview-image text-center text-lg-right content-left-spacer oval-gradient">
                            <div class="app-feature-preview-main animate-float-bob-y wow fadeInUp animated" data-wow-delay="100ms" data-wow-duration="1500ms" style={{visibility: "visible", animationDuration: "1500ms", animationDelay: "100ms", animationName: "float-bob-y"}}>
                                <img src={travel_img3} alt="connect team one" />
                            </div>
                            <div class="app-feature-preview-absolute animate-float-bob-x wow fadeInDown animated" data-wow-delay="200ms" data-wow-duration="1500ms" style={{visibility: "visible", animationDuration: "1500ms", animationDelay: "200ms", animationName: "float-bob-x"}}>
                                <img src={travel_reporting} alt="connect team two" />
                            </div>
                        </div>
                    </div>
                </div> 
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        <div class="app-preview-image oval-gradient content-right-spacer">
                            <div class="app-feature-preview-main wow fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms" style={{visibility: "visible", animationDuration: "1500ms", animationDelay: "200ms", animationName: "fadeInDown"}}>
                                <img src={travel_img4} alt="live collaboration" />
                            </div>
                           
                            <div class="app-feature-preview-absolute animate-float-bob-x wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms" style={{visibility: "visible", animationDuration: "1500ms", animationDelay: "600ms", animationName: "float-bob-x"}}>
                                <img width="175" src={travel_card} alt="chat onboard" />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <div class="section-title section-title-mirage">
                            ...
                            <div class="section-title-description">
                                <p class="mb-13">Book now, pay later. We offer flexible payment options, so you can plan your business trips on the go and pay the way you prefer. You can save your card and make payments with just a click or add funds to your wallet to reap more rewards.</p>
                            </div>
                            {/* <!--<div class="section-button-wrapper">-->
                            <!--    <a class="btn-secondary-custom-a" href="#">Learn More</a>-->
                            <!--</div>--> */}
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 order-1 order-lg-2">
                        <div class="app-preview-image text-center text-lg-right content-left-spacer oval-gradient">
                            <div class="app-feature-preview-main animate-float-bob-y wow fadeInUp animated" data-wow-delay="100ms" data-wow-duration="1500ms" style={{visibility: "visible", animationDuration: "1500ms", animationDelay: "100ms", animationName: "float-bob-y"}}>
                                <img src={travel_img5} alt="connect team one" />
                            </div>
                            <div class="app-feature-preview-absolute animate-float-bob-x wow fadeInDown animated" data-wow-delay="200ms" data-wow-duration="1500ms" style={{visibility: "visible", animationDuration: "1500ms", animationDelay: "200ms", animationName: "float-bob-x"}}>
                                <img src={policy} alt="connect team two" />
                            </div>
                        </div>
                    </div>
                </div> 
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        <div class="app-preview-image oval-gradient content-right-spacer">
                            <div class="app-feature-preview-main wow fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms" style={{visibility: "visible", animationDuration: "1500ms", animationDelay: "200ms", animationName: "fadeInDown"}}>
                                <img src={travel_img6} alt="live collaboration" />
                            </div>
                           
                            <div class="app-feature-preview-absolute animate-float-bob-x wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms" style={{visibility: "visible", animationDuration: "1500ms", animationDelay: "600ms", animationName: "float-bob-x"}}>
                                <img src={customer_care} alt="chat onboard" />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5">
                        <div class="section-title section-title-mirage">
                            ...
                            <div class="section-title-description">
                                <p class="mb-13">Travel Support at its finest. Our customer care is available to you 24/7. We support you from arranging transportation to and from the airport and any other needs you have along the way.</p>
                            </div>
                            {/* <!--<div class="section-button-wrapper">-->
                            <!--    <a class="btn-secondary-custom-a" href="#">Learn More</a>-->
                            <!--</div>--> */}
        ...
        <section class="subscribe-newsletter-area bg-white-lilac pt-80 pb-80" style={{backgroundImage: `url(${newsletter})`}}>
            <div class="container">
                <div class="section-internal">
                    <div class="section-particle-effect d-none d-md-block section-particle-effect-v4">
                        <img class="particle-1 animate-rotate-me" src={particle_two} alt="particle One" />
                        <img class="particle-2 animate-rotate-me" src={particle_one} alt="particle Two" />
                        <img class="particle-3 animate-zoominout" src={particle_four} alt="particle Three" />
                        <img class="particle-4 animate-float-bob-y" src={particle_five} alt="particle Five" />
                    </div>
                        ...
                        <div class="col-xl-7 col-lg-10">
                            <div class="subscribe-newsletter-content">
                                <div class="section-title mb-35">
                                    ...
                                    <h2 class="wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="1500ms">Get full control on your <br class="d-none d-md-block" />business travel.</h2>
                                </div>
                                <div class="newsletter-form newsletter-form-v2 wow fadeInUp" data-wow-delay="0.5s" data-wow-duration="1500ms">
                                    <form action="https://forms.gle/1tdHpLzWG2brgz5k7" target="_blank" rel="noreferrer">
                                        <div class="form-group">
                                            <input type="email" name="email" id="emailAddress" class="form-control" placeholder="Work Email Address" />
                                            <button type="submit" name="submit" value="Go" class="filled-btn bg-filled button-radius btn-bordered">Request Demo</button>
                                        </div>
                                    </form>
