...
function NavBar(){
    ...
    return(
        <div className="header-container">
                ...
                <a onClick={dropProfile} className="sidebarCollapse" data-placement="bottom">
                ...
                {/* END TOPBAR */}
                    ...
                    <ul className="navbar-item flex-row nav-dropdowns">
                        <li className="nav-item dropdown user-profile-dropdown order-lg-0 order-1">
                            <a onClick={dropProfile} className="nav-link dropdown-toggle user" id="user-profile-dropdown" data-toggle="dropdown" aria-expanded="false">
                                <div className="media">
                            ...
                            {profile ? (<div className="dropdown-menu position-absolute animated fadeInUp" aria-labelledby="userProfileDropdown">
