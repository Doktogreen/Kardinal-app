                ...
                {/* END TOPBAR */}
                    ...
                    <ul className="navbar-item flex-row nav-dropdowns">
                        <li className="nav-item dropdown user-profile-dropdown order-lg-0 order-1">
                            <a onClick={dropUser} className="nav-link user" href='...'>
                                <div className="media">
                            ...
                            {openUser && (<div className="dropdown-menu position-absolute animated fadeInUp" aria-labelledby="userProfileDropdown">
