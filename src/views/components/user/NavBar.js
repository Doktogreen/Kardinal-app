...
function NavBar(){
    return(
        <div className="header-container">
                ...
                <li className="font-weight-bold">Ayomide</li>
                </ul>
                ...
                <a href={{javascript:void(0)}} className="nav-link dropdown-toggle user" id="user-profile-dropdown" data-toggle="dropdown" aria-expanded="false">
                <div className="media">
