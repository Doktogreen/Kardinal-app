          ...
          {({
            ...
            <form onSubmit={handleSubmit} action="" id="wizard">
              <div className="content">
                ...
                {page === 1 ? (
                  <form onSubmit={(e) => codeSender(e, values.email)}>
                    <div className="inner">
                    ...
                    <div className="inner">
                      ...
                      <div className="form-content">
                        ...
                        <div className="form-group">
                          ...
                          <div class="input-group-append">
                            <button
                              onClick={() => codeVerifyer(values.confirmCode)}
                              className="btn btn-outline-secondary"
                              type="submit"
                            >
                              Verify
                      ...
                      <div className="form-content">
                        ...
                        >
                          <div
                            ...
                            id="invite_by_email"
                            role="tabpanel"
                            aria-labelledby="invite_by_email_tab"
                          >
                            <div className="form-group mb-2">
                              <label
                          ...
                          <div
                            ...
                            id="invite_by_link"
                            role="tabpanel"
                            aria-labelledby="invite_by_link_tab"
                          >
                            <div className="form-group mb-2">
                              <label
                ...
                <div className="btn-cover">
                  <ul role="" className="row buttons" ariaLabel="Pagination">
                    ...
                    {page < 1 || page === 5 ? null : (
                      <li
                        hidden={!sent}
                        onClick={(e) => increment(e, values.email)}
                        ariaDisabled="false"
                        className=""
                      >
                        <a
